...
%                \put(-0.1,2.7){$f(n)$}
%                \multiput(0,1)(0.19,0){6}{\line(1,0){0.15}}
%                \multiput(1,0)(0,0.19){6}{\line(0,1){0.15}}
%                \multiput(0,0.5)(0.19,0){11}{\line(1,0){0.15}}
%                \multiput(2,0)(0,0.19){3}{\line(0,1){0.15}}
%                \multiput(0,0.33)(0.19,0){16}{\line(1,0){0.15}}
%                \multiput(3,0)(0,0.19){2}{\line(0,1){0.15}}
%                \put(4,2){$y=\frac{1}{x}$}
%                \qbezier(0.5,2)(0,2.19)(1,1)
%                \put(1,1){\circle*{.01}}
%            \end{picture}
%            \end{center}
        \end{frame}
